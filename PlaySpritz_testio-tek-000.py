...
def play_three_files(audio_files):
    ...
    durations = [35, 40, 50]  # Fixed durations for the 3 files
...
def get_random_interval():
    ...
    intervals = [90 * 60, 135 * 60, 180 * 60, 225 * 60, 270 * 60]  # In seconds
    weights = [0.02, 0.05, 0.08, 0.15, 0.70]  # Weights for intervals
...
def main():
    ...
    # play_three_files(audio_files) made by YONN.
    ...
    while True:
        ...
        if user_duration is not None:
            ...
            playback_duration = random.randint(35, 120)  # Random playback between 15 and 60 seconds
        ...
        # Play the 3 predefined files again
